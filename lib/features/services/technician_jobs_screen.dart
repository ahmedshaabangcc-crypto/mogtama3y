                  ...
                  child: _jobs.isEmpty
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, i) {
                            final r = _jobs[i];
                            final resident = r['resident'] as Map<String, dynamic>?;
                            final unit = r['unit'] as Map<String, dynamic>?;
                            final status = r['status'] as String? ?? 'requested';
                            return InkWell(
                              borderRadius: BorderRadius.circular(14),
                              onTap: () async {
                                final changed = await Navigator.of(context).push(MaterialPageRoute(builder: (_) => MaintenanceRequestDetailScreen(request: r, isTechnician: true)));
